...
def update_args_from_model_params(args, N_series, device):
    model_params = {
        'N_series': N_series, 'device': device, # DSD-MTS
...
def parameter_parser():
    parser = argparse.ArgumentParser(description="Run non-stationary forecasting task.")
    ...
    parser.add_argument('--series_mixing', type=bool, default=False, help='series mixing or independent?')  # DSD-MTS or DSM-MTS?
